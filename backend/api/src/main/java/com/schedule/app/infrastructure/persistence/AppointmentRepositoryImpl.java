...
import com.schedule.app.domain.repository.BaseRepository;
...
public class AppointmentRepositoryImpl implements BaseRepository {
    ...
    @Override
    public Appointment save(Appointment base) {
        return appointmentJpaRepository.save(base);
    }

    @Override
    public void delete(Appointment base) {
        appointmentJpaRepository.delete(base);
    }
}
